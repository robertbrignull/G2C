...
EXAMPLES = examples/bayesian examples/large-bayesian examples/coin-flip examples/gaussian-unknown-mean examples/tricky-coin examples/sum-equals examples/function-test examples/marsaglia examples/influence-diagram
