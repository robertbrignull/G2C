...
The following two graphs show running time against number of observes and mean value of the posterior distribution against number of observes (labeled as n).

\centerline{\includegraphics[width=16cm]{images/merging_observes_1.png}}

What you can see from these is firstly that the optimized and non-optimized programs give the same answer, but that the optimized program is far faster. Considering the complexity, it appears that the non-optimized programs have linear or slightly super-linear complexity in the number of observes, however the optimized programs running time remains constant.

I will now investigate the \(n = 30\) case in more detail, looking at both the final posterior distribution and how the mean of it varies over time. These aspects can be seen in the following two graphs.
...
What you can see from these is firstly that the optimized and non-optimized programs give the same answer to within an acceptable margin, but again that the optimized program is far faster. Considering the complexity, it again appears that the non-optimized programs have linear or slightly super-linear complexity in the number of observes, whereas the optimized programs running time remains constant.
