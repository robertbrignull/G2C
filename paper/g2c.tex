...
Here are some examples of the sort of optimizations we could do.
...
Also note that like many of the optimizations we talk about here this would be possible to do by hand, but people should not have to. Therefore this still is a very powerful optimization in that it can greatly improve the quality of the posterior distribution of a badly written program.
