...
The following two graphs show running time againt number of observes and mean value of the posterior distribution against number of observes (labeled as n).
...
What you see from these is again firstly that the optimized and non-optimized programs give the same answer, but the second graph is harder to read. It appears that the optimized program reaches it's final answer after around 600 iterations whilst the non-optimized program has still not converged satisfactorily after 1000 iterations.
