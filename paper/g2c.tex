...
\begin{center}
	...
	\begin{tabular}{lcl}
		...
		\(\begin{array}{l}
			...
			\end{array}\)
		&\(\Rightarrow\)&
		\texttt{[assume y (normal (+ m 15) b)]} \\[10mm]
...
The main aim of all of our optimizations is to reduce the number of observes that the program does, it is these that greatly reduce both the programs performance and the quality of samples.
